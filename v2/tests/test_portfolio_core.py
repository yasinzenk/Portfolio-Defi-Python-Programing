"""Tests for portfolio_core module."""
...
class TestAsset:
    ...
    def test_market_value_calculation(self):
        ...
        asset = Asset(symbol="ETH", amount=2.0, price=3000.0, crypto_id="ETH")
        assert asset.market_value() == 6000.0

    def test_market_value_zero_amount(self):
    ...
    def test_market_value_missing_price(self):
...
class TestPortfolio:
    ...
    def test_empty_portfolio_total_value(self):
        """Test that empty portfolio raises no errors."""
