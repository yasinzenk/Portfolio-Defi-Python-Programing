"""Tests for risk_analyzer module."""
...
class TestPricesToReturns:
    ...
    def test_multiple_columns(self):
        ...
        prices = pd.DataFrame({"ETH": [100, 110], "BTC": [50000, 51000]})
        returns = prices_to_returns(prices)
...
class TestHistoricalVar:
    ...
    def test_var_is_negative_for_losses(self):
        """Test that VaR is typically negative."""
...
class TestPortfolioVolatility:
    ...
    def test_portfolio_vol_is_positive(self):
        """Test that portfolio volatility is positive."""
        returns = pd.DataFrame({
            "ETH": [0.01, -0.02, 0.015],
            "BTC": [0.02, -0.01, 0.01]
        })
        weights = {"ETH": 0.5, "BTC": 0.5}
